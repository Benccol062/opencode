...
export const Definitions = {
  leader: keybind(LeaderDefault, "快捷键组合的前导键"),
  ...
  app_toggle_diffwrap: keybind("none", "切换 diff 换行"),
  ...
  diff_toggle: keybind("enter,space", "展开/收起 diff 查看器条目"),
  diff_expand: keybind("right", "展开 diff 查看器条目"),
  diff_expand_all: keybind("E", "展开所有 diff 查看器文件夹"),
  diff_collapse: keybind("left", "收起 diff 查看器条目"),
  diff_switch_focus: keybind("tab", "切换 diff 查看器焦点"),
  diff_next_hunk: keybind("]", "跳到下一个 diff 块"),
  diff_previous_hunk: keybind("[", "跳到上一个 diff 块"),
  ...
  diff_toggle_view: keybind("v", "切换 diff 查看器分栏/统一视图"),
  diff_help: keybind("?", "显示更多 diff 查看器快捷键"),

  editor_open: keybind("<leader>e", "在外部编辑器中打开"),
  ...
  session_background: keybind("ctrl+b", "后台运行同步子代理"),
  ...
  session_queued_prompts: keybind("<leader>q", "管理排队的提示词"),
  session_child_first: keybind("<leader>down", "跳到首个子会话"),
  session_child_cycle: keybind("right", "跳到下一个子会话"),
  session_child_cycle_reverse: keybind("left", "跳到上一个子会话"),
  session_parent: keybind("up", "跳到父会话"),
  session_pin_toggle: keybind("ctrl+f", "在会话列表中置顶/取消置顶会话"),
  ...
  model_cycle_favorite: keybind("none", "下一个收藏的模型"),
  model_cycle_favorite_reverse: keybind("none", "上一个收藏的模型"),
  ...
  messages_page_up: keybind("pageup,ctrl+alt+b", "消息上滚一页"),
  messages_page_down: keybind("pagedown,ctrl+alt+f", "消息下滚一页"),
  messages_line_up: keybind("ctrl+alt+y", "消息上滚一行"),
  messages_line_down: keybind("ctrl+alt+e", "消息下滚一行"),
  messages_half_page_up: keybind("ctrl+alt+u", "消息上滚半页"),
  messages_half_page_down: keybind("ctrl+alt+d", "消息下滚半页"),
  messages_first: keybind("ctrl+g,home", "跳到首条消息"),
  messages_last: keybind("ctrl+alt+g,end", "跳到末条消息"),
  messages_next: keybind("none", "跳到下一条消息"),
  messages_previous: keybind("none", "跳到上一条消息"),
  messages_last_user: keybind("none", "跳到上一条用户消息"),
  messages_copy: keybind("<leader>y", "复制消息"),
  messages_undo: keybind("<leader>u", "撤销消息"),
  messages_redo: keybind("<leader>r", "重做消息"),
  messages_toggle_conceal: keybind("<leader>h", "切换消息中代码块折叠"),
  tool_details: keybind("none", "切换工具详情可见性"),
  display_thinking: keybind("none", "切换思考块可见性"),

  prompt_submit: keybind("none", "提交提示词词"),
  prompt_editor_context_clear: keybind("none", "清除编辑器上下文"),
  prompt_skills: keybind("none", "打开技能选择器"),
  prompt_stash: keybind("none", "暂存提示词词"),
  prompt_stash_pop: keybind("none", "取回暂存的提示词"),
  ...
  input_move_left: keybind("left,ctrl+b", "在输入中将光标左移"),
  input_move_right: keybind("right,ctrl+f", "在输入中将光标右移"),
  input_move_up: keybind("up", "在输入中将光标上移"),
  input_move_down: keybind("down", "在输入中将光标下移"),
  input_select_left: keybind("shift+left", "在输入中向左选中"),
  input_select_right: keybind("shift+right", "在输入中向右选中"),
  input_select_up: keybind("shift+up", "在输入中向上选中"),
  input_select_down: keybind("shift+down", "在输入中向下选中"),
  input_line_home: keybind("ctrl+a", "在输入中移到行首"),
  input_line_end: keybind("ctrl+e", "在输入中移到行尾"),
  input_select_line_home: keybind("ctrl+shift+a", "在输入中选中到行首"),
  input_select_line_end: keybind("ctrl+shift+e", "在输入中选中到行尾"),
  input_visual_line_home: keybind("alt+a", "在输入中移到可视行行首"),
  input_visual_line_end: keybind("alt+e", "在输入中移到可视行行尾"),
  input_select_visual_line_home: keybind("alt+shift+a", "在输入中选中到可视行行首"),
  input_select_visual_line_end: keybind("alt+shift+e", "在输入中选中到可视行行尾"),
  input_buffer_home: keybind("home", "在输入中移到缓冲区开头"),
  input_buffer_end: keybind("end", "在输入中移到缓冲区结尾"),
  input_select_buffer_home: keybind("shift+home", "在输入中选中到缓冲区开头"),
  input_select_buffer_end: keybind("shift+end", "在输入中选中到缓冲区结尾"),
  input_delete_line: keybind("ctrl+shift+d", "在输入中删除整行"),
  input_delete_to_line_end: keybind("ctrl+k", "在输入中删除到行尾"),
  input_delete_to_line_start: keybind("ctrl+u", "在输入中删除到行首"),
  input_backspace: keybind("backspace,shift+backspace", "在输入中退格"),
  input_delete: keybind("ctrl+d,delete,shift+delete", "在输入中删除字符"),
  input_undo: keybind("ctrl+-,super+z", "在输入中撤销"),
  input_redo: keybind("ctrl+.,super+shift+z", "在输入中重做"),
  input_word_forward: keybind("alt+f,alt+right,ctrl+right", "在输入中按词前移"),
  input_word_backward: keybind("alt+b,alt+left,ctrl+left", "在输入中按词后移"),
  input_select_word_forward: keybind("alt+shift+f,alt+shift+right", "在输入中按词向前选中"),
  input_select_word_backward: keybind("alt+shift+b,alt+shift+left", "在输入中按词向后选中"),
  input_delete_word_forward: keybind("alt+d,alt+delete,ctrl+delete", "在输入中按词向前删除"),
  input_delete_word_backward: keybind("ctrl+w,ctrl+backspace,alt+backspace", "在输入中按词向后删除"),
  input_select_all: keybind("super+a", "在输入中全选"),
  history_previous: keybind("up", "上一条历史记录"),
  history_next: keybind("down", "下一条历史记录"),

  "dialog.select.prev": keybind("up,ctrl+p", "在对话框中移到上一项"),
  "dialog.select.next": keybind("down,ctrl+n", "在对话框中移到下一项"),
  "dialog.select.page_up": keybind("pageup", "在对话框中上移一页"),
  "dialog.select.page_down": keybind("pagedown", "在对话框中下移一页"),
  "dialog.select.home": keybind("home", "在对话框中移到第一项"),
  "dialog.select.end": keybind("end", "在对话框中移到最后一项"),
  ...
  "prompt.autocomplete.prev": keybind("up,ctrl+p", "在自动补全中移到上一项"),
  "prompt.autocomplete.next": keybind("down,ctrl+n", "在自动补全中移到下一项"),
  "prompt.autocomplete.hide": keybind("escape", "隐藏自动补全"),
  "prompt.autocomplete.select": keybind("return", "选中自动补全项"),
  "prompt.autocomplete.complete": keybind("tab", "补全自动补全项"),
  ...
  tips_toggle: keybind("<leader>h", "切换主屏幕提示"),
  plugin_manager: keybind("none", "打开插件管理对话框"),
  plugin_install: keybind("none", "安装插件"),

  which_key_toggle: keybind("ctrl+alt+k", "切换 which-key 面板"),
  which_key_layout_toggle: keybind("ctrl+alt+shift+k", "切换 which-key 布局"),
  which_key_pending_toggle: keybind("ctrl+alt+shift+p", "切换 which-key 待按键预览"),
  which_key_group_previous: keybind("ctrl+alt+left,ctrl+alt+[", "上一个 which-key 分组"),
  which_key_group_next: keybind("ctrl+alt+right,ctrl+alt+]", "下一个 which-key 分组"),
  which_key_scroll_up: keybind("ctrl+alt+up,ctrl+alt+p", "将 which-key 向上滚动"),
  which_key_scroll_down: keybind("ctrl+alt+down,ctrl+alt+n", "将 which-key 向下滚动"),
  which_key_page_up: keybind("ctrl+alt+pageup", "将 which-key 上翻一页"),
  which_key_page_down: keybind("ctrl+alt+pagedown", "将 which-key 下翻一页"),
  which_key_home: keybind("ctrl+alt+home", "跳转到第一个 which-key 绑定"),
  which_key_end: keybind("ctrl+alt+end", "跳转到最后一个 which-key 绑定"),
